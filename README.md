...
@chec/cli/1.2.1 darwin-x64 node-v12.20.0
$ chec --help [COMMAND]
USAGE
  $ chec COMMAND
...
...
_See code: [src/commands/demo-store.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/demo-store.js)_
...
_See code: [src/commands/log.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/log.js)_
...
_See code: [src/commands/login.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/login.js)_
...
_See code: [src/commands/logout.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/logout.js)_
...
_See code: [src/commands/logs.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/logs.js)_
...
_See code: [src/commands/register.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/register.js)_
...
_See code: [src/commands/request.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/request.js)_
...
_See code: [src/commands/whoami.js](https://github.com/chec/cli/blob/v1.2.1/src/commands/whoami.js)_
<!-- commandsstop -->
